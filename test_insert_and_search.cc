// Main file for testing insert & search routine for binomial queue.
// @filename: test_insert_and_search.cc
// Homework 4 - CSCI 335.
...
// Use the code as is in function TestInsertAndSearch(). Do not insert or remove code.
...
void TestInsertAndSearch(const string &create_queue_file, const string &check_search_file) {
  ifstream numbers_in;  
...
int main(int argc, char **argv) {
  ...
  TestInsertAndSearch(create_queue_file, check_search_file);
